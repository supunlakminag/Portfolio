  ...
  return (
    <div className='mx-auto max-w-6xl w-full min-h-screen p-4 md:p-8 lg:p-28 flex flex-col md:flex-row items-center justify-center gap-10' id='about'>
      ...
      <motion.img
        src="/image.jpg"
        alt="Profile"
        className='w-[900px] md:w-[280px] rounded-full hover:shadow-2xl hover:shadow-blue-800 hover:scale-105 hover:rotate-2 transition-all duration-500'
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <h1 className="text-5xl md:text-4xl lg:text-6xl font-semibold bg-gradient-to-r from-white via-orange-200 to-white text-transparent bg-clip-text">
          Supun Gamage
        </h1>
        <h3 className="text-xl md:text-2xl lg:text-3xl font-light text-slate-700">
          Software Developer
        </h3>
        ...
        <div className='flex gap-5 mt-3'>
          <a href="https://github.com/yourprofile" target="_blank" rel="noopener noreferrer">
            <BiLogoGithub className='text-3xl text-white cursor-pointer hover:scale-110 hover:text-black hover:rotate-12 transition-all duration-300 ease-in-out' />
          </a>
